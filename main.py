...
time3 = TimeSlot(start_minute=5 * 60, end_minute=(5 * 60) + 30) # 5:00 PM to 5:30 PM
time4 = TimeSlot(start_minute=8 * 60, end_minute=(8 * 60) + 30) # 8:00 AM to 8:30 AM
time5 = TimeSlot(start_minute=4 * 60, end_minute=(4 * 60) + 10) # 4:00 PM to 4:10 PM
...
owner1.set_availability(slots=[time1, time2]) #should work since these are 30 and 15 min long 
